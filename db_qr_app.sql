...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-10-2022 a las 18:33:44
...
--
-- Base de datos: `db_api_django`
--
CREATE DATABASE IF NOT EXISTS `db_api_django` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_api_django`;
...
INSERT INTO `alumno` (`run`, `nombre`, `correo`) VALUES
(20906454, 'David', 'dav.martinez@duocuc.cl'),
(20906454, 'David', 'dav.martinez@duocuc.cl'),
(21189889, 'Javier', 'ja.inostroza@duocuc'),
(21189889, 'Javier', 'ja.inostroza@duocuc.cl');
...
(1, 'contenttypes', '0001_initial', '2022-10-04 20:42:49.926762'),
(2, 'auth', '0001_initial', '2022-10-04 20:42:50.175532'),
(3, 'admin', '0001_initial', '2022-10-04 20:42:50.238066'),
(4, 'admin', '0002_logentry_remove_auto_add', '2022-10-04 20:42:50.244440'),
(5, 'admin', '0003_logentry_add_action_flag_choices', '2022-10-04 20:42:50.252489'),
(6, 'contenttypes', '0002_remove_content_type_name', '2022-10-04 20:42:50.306517'),
(7, 'auth', '0002_alter_permission_name_max_length', '2022-10-04 20:42:50.333645'),
(8, 'auth', '0003_alter_user_email_max_length', '2022-10-04 20:42:50.345606'),
(9, 'auth', '0004_alter_user_username_opts', '2022-10-04 20:42:50.350589'),
(10, 'auth', '0005_alter_user_last_login_null', '2022-10-04 20:42:50.379943'),
(11, 'auth', '0006_require_contenttypes_0002', '2022-10-04 20:42:50.381937'),
(12, 'auth', '0007_alter_validators_add_error_messages', '2022-10-04 20:42:50.386920'),
(13, 'auth', '0008_alter_user_username_max_length', '2022-10-04 20:42:50.399878'),
(14, 'auth', '0009_alter_user_last_name_max_length', '2022-10-04 20:42:50.410832'),
(15, 'auth', '0010_alter_group_name_max_length', '2022-10-04 20:42:50.423794'),
(16, 'auth', '0011_update_proxy_permissions', '2022-10-04 20:42:50.429774'),
(17, 'auth', '0012_alter_user_first_name_max_length', '2022-10-04 20:42:50.439739'),
(18, 'sessions', '0001_initial', '2022-10-04 20:42:50.462663');
...
('MAT4140', 'ESTADISTICA DESCRIPTIVA'),
('PGY4121', 'PROGRAMACION DE APLICACIONES MOVILES');
...
('001D', 'PROGRAMACION DE APLICACIONES MOVILES'),
('002D', 'PROGRAMACION DE APLICACIONES MOVILES'),
('003D', 'PROGRAMACION DE APLICACIONES MOVILES'),
('004D', 'ESTADISTICA DESCRIPTIVA'),
('005D', 'ESTADISTICA DESCRIPTIVA'),
('006D', 'ESTADISTICA DESCRIPTIVA');
...
(20906454, 5, 'David', 'Martinez', 'Manciet', 'dav.martinez', '20906454', 1),
(21189822, 2, 'David walter', 'marano', 'medino', 'dav.marano', '20904454', 1),
...
('root', '[{\"db\":\"db_qr_app\",\"table\":\"estudiante\"},{\"db\":\"db_qr_app\",\"table\":\"tipo_user\"},{\"db\":\"db_qr_app\",\"table\":\"profesor\"},{\"db\":\"db_qr_app\",\"table\":\"auth_user\"},{\"db\":\"db_qr_app\",\"table\":\"curso\"},{\"db\":\"db_api_django\",\"table\":\"alumno\"}]');
...
('root', '2022-10-12 16:32:43', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
